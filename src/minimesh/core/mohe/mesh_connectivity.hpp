	...
	namespace mohe
	{
		...
		public:
			...
			private:
				...
				// clang-format off
				Vertex_iterator(const int index, Mesh_connectivity* parent)
			...
			private:
				...
				// clang-format off
				Half_edge_iterator(const int index, Mesh_connectivity* parent)
						:_parent(parent), _index(index)
				{
				}
			...
			private:
				...
				// clang-format off
				Face_iterator(const int index, Mesh_connectivity* parent)
						:_parent(parent), _index(index)
				{
				}
