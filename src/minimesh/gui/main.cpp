...
namespace freeglutcallback {
    ...
    void visualize_pressed(int) {
        printf("Visualize button was pressed show %d edges \n to remove", globalvars::num_entities_to_simplify);
    }
...
main(int argc, char *argv[]) {
    ...
    // Add the "Visualize" button to show the current triangles
